...
let person_name :string = 'Kainat';
let person_name2 :string = 'kainat Akmal';
let person_name3 :string = 'kainat Abbasi';
...
const result: string = inputStr.toLowerCase();
...
// part 3
let numeralNumber :number = 20;
let numeralNumber1 :number = 25;
...
// part5
let FruitList :string[] = ['Apple', 'Mango', 'Banana', 'Peach'];
